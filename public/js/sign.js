  ...
  axios.get("https://cryptonut.herokuapp.com/user/checkauth")
    .then(res => {
      if(res.data == "auth"){
        ...
        displayTopHeaders(false, username);
      }
  });
});
...
$("#register_btn").click(() =>{
  ...
  if(email != "" && username != "" && password != ""){
    if(validateEmail(email)){
      ...
      axios.post("https://cryptonut.herokuapp.com/user", {email: email, username: username, password: password})
        .then(res => {
...
$("#login_btn").on("click", () => {
  ...
  if(username != "" && password != ""){
    axios.post("https://cryptonut.herokuapp.com/user/login", {username: username, password: password})
      .then(res => {
...
$("#logout_btn").on("click", () =>{
  ...
  axios.get("https://cryptonut.herokuapp.com/user/logout")
    .then(res => {
      console.log(res);
