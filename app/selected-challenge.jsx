  ...
  return (
    <tr>
      <td className="currency"><span className="currency_rank">{props.number}</span>
        <img className="currency_logo_img" src="./home/Challenge_uncompleted.png" width="23" height="23" />{props.username}
      </td>
...
class SelectedChallengeContainer extends React.Component {
  ...
  startChallenge(name){
    axios.post("https://cryptonut.herokuapp.com/challenge", {username: getCookie("username"), name: name})
      .then(res => {
        if(res.data.msg == "200"){
